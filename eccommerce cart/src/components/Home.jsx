    ...
    <header>
      <div className='container'>
        <div className='headercontent'>
          <h1>Lorem ipsum dolor sit amet consectetur adipisicing elit. Laborum, laboriosam?</h1>
      ...
      {product?.map((productitem,productindex)=>{
            return(
              <div key={productindex} style={{width:'33.3%'}}>
                <div className='product-item'>
                <img src={productitem.image} width={'30%'} />
